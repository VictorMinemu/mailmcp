...
Changes to credentials, sessions, access tokens, attachments or account mutations need meaningful tests for unauthorized access and failure paths. Prefer synthetic MIME fixtures and temporary directories. Clearly distinguish fixture coverage from live provider integration checks. UI and application MCP strings live in shared English/Spanish catalogs under `locales/`; contributor documentation is English. See [language contributions](docs/LANGUAGES.md).
